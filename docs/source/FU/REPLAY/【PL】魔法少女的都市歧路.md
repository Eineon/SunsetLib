...
**身高**：152CM<br>
**体重**：47KG<br>
**隶属机构**：前S公司第VII期认知强化项目（982-996年）<br>
**基因谱系**：人类基准基因组
...
- **食尘诅咒**：如果生物处于**缓慢**状态，则她需要使用2次【攻击】动作才能完成1次近战攻击。<br>
  承受该诅咒的生物，DEX骰尺寸-1(最低D4)，并且无法免疫和解除缓慢状态。
- **谵妄诅咒**：如果生物处于**眩晕**状态，则她使用仅将自己或盟友作为目标的动作时，必须进行1次DL10的【INS+WLP】检定。失败则动作无效。<br>
  承受该诅咒的生物，INS骰尺寸-1(最低D4)，并且无法免疫和解除眩晕状态。
- **幼化诅咒**：如果生物处于**虚弱**状态，则她通过检定包含MIG的攻击，造成的物理伤害减半。<br>
  承受该诅咒的生物，MIG骰尺寸-1(最低D4)，并且无法免疫和解除虚弱状态。
- **涣散诅咒**：如果生物处于**动摇**状态，则她通过施法检定包含WLP的咒语，造成的伤害与治疗减半。<br>
  承受该诅咒的生物，WLP骰尺寸-1(最低D4)，并且无法免疫和解除动摇状态。
:::
:::{admonition} 【锥身诅咒】
