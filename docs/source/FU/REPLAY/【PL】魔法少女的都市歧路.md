...
流浪在霓虹沼泽的灵能者，总会在雨季听见往生者的呢喃。那双透明的手会为她拂去睫毛上的雨珠，会在她凝视深渊时轻轻遮住她的眼睛，就像多年前虚拟花田里，那个孩子捂住她窥见真相的双眸那样。
...
PX-0912作为第七代「星茧」培育舱诞生的巅峰产物，其灵能天赋在植入诫命回路后产生了颠覆性进化。该个体大脑皮层持续释放的量子态神经脉冲，在虚拟生态舱测试中曾诱发三台星茧主机逻辑核心熔毁。<br>
新世纪992年███事件中，PX-0912通过与PX-0915构建跨维度意识纠缠网络，突破████级收容协议的量子锁定。经逆向工程解析，其逃亡时形成的「反追踪屏障」实为自发性灵能蜕变：神经突触茧化过程中自主激发的相位偏移场，可使热光学/中微子扫描仪等探测手段的感知数据产生递归性坍缩，观测者意识将不自觉地锚定在由其记忆碎片编织的认知镜像中。

**关键事件节点**：<br>
培育期 (982-996) --> 逃亡事件 (996.██.12) --> 流浪期 (996-至今)
...
:::{admonition} 【荒疫诅咒】
每轮1次，当你命中1名承受状态效果的生物时，可以消耗1件幻影武器，造成以下诅咒之一。这些诅咒视为状态效果。
...
- **幼化诅咒**：如果生物处于**虚弱**状态，则她通过检定包含MIG属性的攻击，造成的物理伤害减半。<br>
  承受该诅咒的生物，MIG骰尺寸-1(最低D4)，并且无法免疫和解除虚弱状态。
- **涣散诅咒**：如果生物处于**动摇**状态，则她通过施法检定包含WLP属性的咒语，造成的伤害与治疗减半。<br>
