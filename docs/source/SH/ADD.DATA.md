...
导致角色在解体护符上划下斩痕的伤害属性尤为重要，这将决定重创标签的外在形式。例如，物理伤害可能会导致内脏破裂，欣快伤害可能会使角色对敌人产生好感。
...
**费用**：1 \
**时效**：场景 \
你的武术为【魂体】生物赋予【生命伤害】附魔时，赋予相同目标【生命伤害(心神)_2】附魔。

##### 斩灵
*2L 武术* \
**费用**：1 \
**时效**：场景 \
你的武术为拥有【易伤】的生物赋予伤害属性相同的【生命伤害】附魔时，赋予相同目标【生命伤害(心神)_2】附魔。

##### 般若
*2L 武术* \
**费用**：X \
对1名目标进行1次对抗检定 (攻击检定 vs 防御检定)。若命中则将［CAT+X-1］级CAT分配在下述附魔上，赋予目标：生命伤害(物理)、灵力伤害(心神)。X最高为5。
...
赋予触发本技艺的攻击目标【灵毒】附魔。
> 【**灵毒**】：二阶；持续；是；负面 \
> ｜目标每次消耗MP时，赋予自身【生命伤害(心神)_［POW］】附魔。
...
赋予触发本技艺的攻击目标【暗影】附魔。
> 【**暗影**】：二阶；持续；是；负面 \
> ｜目标的武技攻击检定失败时，赋予自身【生命伤害(心神)_［POW］】附魔。
...
**费用**：2 \
**时效**：场景 \
【魂体】生物会尽量避免进入当前场景，强行进入将受到【复合伤害(心神)_1】附魔，你也会获得警示。
...
[符文] \
**费用**：1 \
对1名目标进行1次对抗检定 (危害检定 vs 心魂抵抗)。若抵抗失败的目标拥有所选的生物标签，则赋予目标【生命伤害(心神)_［CAT+2］】附魔。
...
> 【**钉身**】：二阶；持续；是；正面 \
> ｜目标受到【防御无效(反击)】常驻附魔。目标受到其他来源的【伤害】附魔时，赋予目标无来源的【生命伤害(心神)_［POW］】附魔。
...
**费用**：3 \
**时效**：场景 \
对1名目标进行1次对抗检定 (危害检定 vs 心魂抵抗)，抵抗失败则赋予目标无来源的【持续生命伤害(心神)】附魔。
...
[咒语] \
**费用**：X \
对1名目标进行1次对抗检定 (危害检定 vs 体魄抵抗)，抵抗失败则赋予目标【生命伤害_［CAT+X-1］】附魔，伤害属性由你展现本技艺的方式决定。X最高为5。
