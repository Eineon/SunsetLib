...
**费用**：X \
**触发**：妳的灵术攻击检定成功时 \
X最高为5。赋予触发本技艺的攻击目标【生命伤害_［X-1］】附魔，伤害属性由触发本技艺的灵术展现方式决定。
...
**费用**：1 \
**时效**：场景 \
妳的武术为【魂体】生物赋予【生命伤害】附魔时，赋予相同目标【生命伤害(失神)_2】附魔。

##### 斩灵
*2L 武术* \
**费用**：1 \
**时效**：场景 \
妳的武术为拥有【易伤】的生物赋予伤害属性相同的【伤害】附魔时，赋予相同目标【生命伤害(失神)_2】附魔。

##### 般若
*2L 武术* \
[攻势] \
**费用**：1+X \
X最低为0，最高为4。选择1名目标，对其发起1次对抗检定 (攻击检定 vs 防御检定)，成功则将［CAT+X］级CAT分配在下述附魔上，赋予目标：生命伤害(物理)、生命伤害(失神)。
...
赋予触发本技艺的攻击目标【灵毒】附魔。
> 【**灵毒**】：二阶；持续；是；负面 \
> ｜客体每次消耗MP时，赋予自身【生命伤害(失神)_［POW］】附魔。
...
赋予触发本技艺的攻击目标【暗影】附魔。
> 【**暗影**】：二阶；持续；是；负面 \
> ｜客体的武术攻击检定失败时，赋予自身【生命伤害(失神)_［POW］】附魔。
...
**费用**：2 \
**时效**：活动 \
【魂体】生物会尽量避免进入目标场景，强行进入将承受【复合伤害(失神)_1】附魔，妳也会获得警示。
...
若抵抗失败的目标拥有所选的生物标签，则赋予目标【生命伤害(失神)_［CAT+2］】附魔。
...
**费用**：3 \
**时效**：场景 \
选择1名目标，对其发起1次对抗检定 (危害检定 vs 心魂抵抗)，赋予抵抗失败的目标无主【持续生命伤害(失神)】附魔。
...
**费用**：1+X \
**触发**：妳使其他角色承受损伤时 \
X最高为4。将X级CAT分配在所选附魔上，赋予承受损伤的其中1名角色。
...
[攻势] [咒语] \
**费用**：2 \
选择1名目标，对其发起1次对抗检定 (危害检定 vs 智慧抵抗)。若抵抗失败，则将［CAT+2］级CAT分配在下述附魔上，赋予目标：生命伤害(失神)、灵力伤害(失神)、强化格挡。
