...
| 强化力量 | 客体进行的攻击检定获得［POW］点状态加值。                                           |   一阶   |   持续   |    是    |   正面   |
| 削弱力量 | 客体进行的攻击检定受到［POW］点状态减值。                                           |   一阶   |   持续   |    是    |   负面   |
| 强化敏捷 | 客体受到的攻击检定受到［POW］点状态减值。                                           |   一阶   |   持续   |    是    |   正面   |
| 削弱敏捷 | 客体受到的攻击检定获得［POW］点状态加值。                                           |   一阶   |   持续   |    是    |   负面   |
...
- **启动**：只要准备该技艺，角色就可以根据〖**启动**〗词条后所述的文本，将对应效果作为名为「启动-该技艺名称」的不同技艺〖**瞬发**〗。
...
若妳检定成功，则使用相同的CAT对目标〖**瞬发**〗1次【打击】技艺。若妳的CAT到达2级，还会打断目标的行动。
...
**费用**：2 \
**时效**：1轮 \
〖**瞬发**〗1次【打击】技艺，若命中则赋予自身【强化力量(武技)_2】与【强化敏捷(武技)_2】附魔。
...
*2L 武术* \
**费用**：无
> **准备**：妳以反制检定进行防御时，检定级别+［X］。X等于［自身损伤÷2］。
...
> **准备**：选择1种生物标签。可以重复准备本技艺，此时负荷-1，但必须选择不同的标签。
...
若目标以格挡进行防御则提前结束本技艺。
> **准备**：选择1种伤害属性。可以重复准备本技艺，此时负荷-1，但必须选择不同的属性。
...
赋予自身【战歌】附魔。
> 【**战歌**】：二阶；持续；是；正面 \
> ｜客体的武技攻击检定成功时，增加［POW］级CAT，并选择1名自愿目标，赋予其【战歌_［POW］】附魔，持续1轮。生效后失去本附魔。
...
妳进行的武技攻击检定，若是对抗检定中的挑战方，则应对方无法进行防御检定，防御值视为10。
...
赋予被命中的目标【生命伤害(物理)_1】附魔，随后赋予自身【生命治疗_X】附魔。X等于通过本技艺给予的损伤总值。
...
赋予自身【天罡】附魔。
> 【**天罡**】：三阶；持续；是；正面 \
> ｜自获得本附魔起，任意角色第7次被客体发动的武技攻击检定命中时，赋予其无主【毁灭_［POW］】附魔，随后重新开始计数。
