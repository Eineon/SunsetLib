...
### 作为兼职角色
- 获得「源术师核心特质」中的以下能力：生命值骰、职业熟练、豁免倾向
- 获得源术师的1级特性
...
### 1级：原能念力
源术师能够使用原力——这是一种特殊的法术，不过它会汲取源术师体内的精神力，而且没有法术成分，可以随意使用。 \
...
- **通用原力**：「源术师特性」表中的**原力**一列显示了你在每个等级能够习得的通用原力总数。每次提升职业等级时，你都可以更换1项该原力。
...
#### 注能原力
「源术师特性」表中的**原力**一列显示了你在每个等级能够习得的注能原力总数。每次提升职业等级时，你都可以更换1项该原力。 \
...
### 1级：超载
源术师能够超负荷地运用身体，并引发比平时更强大的力量，冒险跨过安全的界限并承受力量的反噬。 \
每拥有1点超载，你就会在力量・敏捷检定上承受1点减值。完成长休能够消除所有超载。 \
「源术师特性」表中的**超载**一列显示了每个等级你每轮能够进行的最大超载点数。 \
...
### 2级：储念器
源术师对自己身体与元素念力进行了长时间的研究，这让你可以在体内构筑出内在储念器用以存贮额外的能量。 \
当你需要承受超载时，可以将其中的一部分或全部超载填充在储念器中，使你免受承受超载的不利影响。 \
「源术师特性」表中的**超载**一列显示了每个等级储念器能够填充的超载数量。 \
...
2. 以【威能】动作承受1点超载，你能够选择将任何已知的原力变为任意一个类别相同的其他原力 (比如简易念袭或护身原力)，持续至完成长休。这会忽略任何关于元素的要求或者制约 (但并不能无视其他先决条件和制约)。
