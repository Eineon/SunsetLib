...
矮人拥有以下种族特性。
- **黑暗视觉**：你拥有黑暗视觉。
- **矮人刚毅**：你的最大HP增加［人物等级］点。

**种族天赋**：从下列天赋中选择1项。
- **古血矮人**：你可以使用反应，使自身对抗法术和其他魔法效应的豁免检定获得1点支援，持续至你的下个回合开始。
- **守陵矮人**：你对负能量伤害具有抗性。你对抗虚能效应，或是亡灵施展的法术和其他魔法效应时进行的豁免检定具有优势。
...
##### 1级：擦掠攻击
你拥有熟练的武器攻击失手时，若判定值比目标值低不超过5点，则依然可以对目标造成［WD枚数+AKM］点擦掠伤害，伤害类型与攻击相同。WD尺寸每比4高2点，就将擦掠伤害增加［WD枚数÷2］点。 \
...
##### 5级：踏入传奇
你获得以下特性。每项特性在使用后，你需要完成1次短休・长休才能再次使用。此后每提升6级，分别增加1次每项特性的使用次数。
...
##### 5级：适时处决
若威胁范围内的生物因你造成的伤害而陷入垂危，你可以消耗1次英雄激励，迫使目标进行1次对抗伤害效应DC的反射豁免。 \
若目标豁免失败，作为此次伤害的一部分，你可以处决目标，并且不会引发借机攻击。 \
你无法以此处决拥有传奇抗性的生物。
