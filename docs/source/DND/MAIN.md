...
#### 伤害相性
生物对不同类型的伤害具有相性，共分为五类，对应五种相性强度：毁灭 (强度-2及以下)、易伤 (强度-1)、通常 (强度0)、抗性 (强度1)、免疫 (强度2及以上)。
...
:class: seealso
记作「**混合伤害[(伤害列表)]**」。 \
受到混合伤害时，以你对所有相关伤害类型的相性强度总和，决定你对本次伤害的整体相性。 \
例如，拥有「火焰免疫」与「寒冷易伤」的生物，对抗「混合伤害[火焰，寒冷]」的相性强度总和为1，因此视为具有抗性。
:::
...
#### 法力骰
你的法力骰尺寸为D4。SPR1级起每提升4级，就将法力骰尺寸提升1级，不计入无【施法】职业的SPR。 \
