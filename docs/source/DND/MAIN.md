...
受到伤害不会再引发专注豁免，改为一次性因受到伤害而失去至少［(专注SC-10)×2］(最低1) 点HP则打断专注。 \
...
- **惊惧**：记作「**惊惧_(强度)**」。你的D20检定与DC全部受到［强度］点内在减值。每当你结束回合时，降低1点强度。
...
#### 艺人工具
取代原本的乐器，艺人工具分为以下6种：舞蹈工具、戏剧工具、键盘乐器、弦乐器、管乐器、敲击乐器。
