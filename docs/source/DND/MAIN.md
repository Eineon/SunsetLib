...
##### 命能治疗
拥有【命能治疗】原型的生物会被命能治疗、被虚能伤害，并免疫正能量伤害。

##### 虚能治疗
拥有【虚能治疗】原型的生物会被命能伤害、被虚能治疗，并免疫负能量伤害。
...
如果豁免检定掷出N1，或是DC比豁免判定值高出至少10点，还会形成特殊重击，取满基础伤害骰。

:::{admonition} 免疫重击
:class: seealso
免疫重击的生物不会受到重击伤害，但此次攻击的其他伤害依然会如常影响这名生物，也无法避免特殊重击导致的取满基础伤害骰。
:::
...
##### 5级：毁灭攻击
你可以在自身发动的攻击命中时造成额外伤害，伤害值由攻击类型决定。 \
一名生物每回合最多承受1次此伤害。11级/17级起，将此额外伤害骰枚数提升至原本的2倍/3倍。
- **武器攻击**：造成［1WD］点相同类型的额外伤害。
- **法术攻击**：造成［1PD］点相同类型的额外伤害。
