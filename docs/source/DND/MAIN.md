...
:class: seealso
记作「**混合伤害[(伤害列表)]**」。 \
受到混合伤害时，以你对所有相关伤害类型的相性强度总和，决定对抗本次伤害的整体相性。 \
...
### 技力
你拥有［(人物等级+基本职业属性值-9)÷4］(最低1) 点（技力:Artistry Points, AP）。部分职业特性需要通过消耗AP发动。 \
已消耗的AP会在你完成长休时恢复。完成短休能够将剩余AP恢复至［PB÷2］点 (若原本更低)。
