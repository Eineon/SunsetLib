...
##### 徒手战斗
*战斗风格专长（先决：战斗风格特性）* \
你的徒手打击伤害骰提升至2D3。如果发动徒手打击时没有持用其他武器或盾牌，则再提升1级伤害骰尺寸。 \
...
#### 武器伤害骰
根据下表替换大于1D4的武器伤害骰，以及使用武艺骰代替武器攻击伤害时的伤害骰。
...
#### 豁免等级
基础豁免的（豁免等级:Saving Class）等于［10+对应豁免总修正］。SC有时会代替AC作为攻击检定的目标值。 \
...
##### 1级：强力攻击
当你发动的拥有熟练的攻击失手时，若判定值比目标值低不超过4点，你依然可以对目标造成［PB+攻击属性调整值］点相同类型的伤害。 \
如果你无法将攻击属性调整值加入此次攻击的伤害，则同样无法将攻击属性调整值加入这一伤害。
...
- **凶暴形态**：10级起，当你触及范围内可见的生物对你以外的生物发动攻击时，你可以消耗1次借机攻击使此次攻击承受劣势。 \
