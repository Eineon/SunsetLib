...
##### 巨武器战斗
*战斗风格专长（先决：APR2+，力量13+）* \
当你共持拥有「双手」或「多用」词条的武器使用**攻击姿态**时，该武器的伤害骰级别获得2点内在加值。 \
...
- **致命灵巧**：执行【攻击】动作・发动借机攻击时，如果攻击属性为敏捷，伤害骰级别获得1点增强加值，最高6级。副手攻击不会获得本增益。
...
##### 战斗反射
*战斗风格专长（先决：APR2+，敏捷15+）* \
你每轮可以额外发动1次借机攻击。如果你的敏捷19+，则可以额外发动2次。 \
...
12级起，【反射闪避】的效果改为「只要你未失能，反射豁免成功则不受任何效应，豁免失败则仅承受一半伤害」。
...
【岿然不动】的效果改为「只要你未失能，强韧豁免成功则不受任何效应，豁免失败则仅承受一半伤害」。 \
【英勇无畏】的效果改为「只要你未失能，意志豁免成功则不受任何效应，豁免失败则仅承受一半伤害」。

##### 精通双持
*通用专长（先决：APR2+，力量或敏捷13+）* \
你获得以下增益：
- **强化双持**：进行双持攻击时，主手・副手攻击因此承受的减值各降低2点。
- **双持防御**：至少持用2把武器时，你可以使AC获得1点加值，如同持用盾牌。你可以使用副手武器代替盾牌，使用那些要求你持用盾牌的效果。
