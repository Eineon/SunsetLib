...
- **增强障壁**：每个你的回合1次，你能够给予自己［1D8+WIS］(最低1) 点增强障壁。 \
  你能够使用此特性的次数等于WIS (最低1)，当你完成一次长休时，你重获全部已消耗的使用次数。
- **减少力竭**：当你完成一次短休时，你的力竭等级减少1级 (若有)。
...
当你使用自己制造的枪械或弹药时，可以将［AKM-2］(最低0) 加入枪械造成的伤害中，并将重击伤害提升至4D10。9级起，重击伤害提升至6D10；17级起，提升至8D10。
