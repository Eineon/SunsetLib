document.addEventListener('DOMContentLoaded', function () {
  ...
  const tagData = {
    ...
    '装填': '这种武器每轮只能使用1次。',
    '————': '——————————————————————————————————————————————————',
    '歪曲': '歪曲术法能够对现实进行扭曲和变化，使其符合施术者的期望和意图。<br>这种术法同时视为具有<a href="##">魔能</a>标签。',
    '感测': '感测术法能够赋予施术者超越常规感官的知觉，增强对环境或情感的理解力。<br>这种术法同时视为具有<a href="##">魔能</a>标签。',
    '具现': '具现术法能够凭空创造现实中不存在的幻想产物，形成具象的实体或现象。<br>这种术法同时视为具有<a href="##">魔能</a>标签。',
    '破灭': '破灭术法能够毁坏或削弱目标事物的存在，将其彻底抹消。<br>这种术法同时视为具有<a href="##">魔能</a>标签。',
    ...
    '塑体': '这种效果能够细微改变角色的外形。任何由塑体效果赋予的攻击手段都具有<a href="##">魔能</a>标签。<br>如果一名角色同时受到多个影响同一部位的塑体效果，新的效果必须成功反制现有效果才能生效。如果这些效果会影响不同的部位，则可以同时生效。',
