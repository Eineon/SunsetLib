document.addEventListener('DOMContentLoaded', function () {
  ...
  const tagData = {
    ...
    '扫荡': '这种效果能令立即将角色无力化，但难以对较为强大的角色产生效果。<br>角色的LV每比扫荡效果的使用者高1级，就会在应对扫荡效果的防御检定上获得1点加值。',
    ...
    '装填': '这种武器每刻只能使用1次。',
    '弹药': '每次使用这种物品都会消耗1发弹药。如果弹药耗尽，则无法再次使用这件物品。角色可以通过【促进】重装1件物品的所有弹药。',
    '————': '——————————————————————————————————————————————————',
  };
  ...
  const efctData = {
    ...
    '缓慢': '角色的延迟受到等于效果值的状态加值。<br><a href="##">缓慢</a>处境的效果值会与<a href="##">迅捷</a>处境互相抵消。',
    ...
    '迅捷': '角色的延迟获得等于效果值的状态减值。<br><a href="##">迅捷</a>处境的效果值会与<a href="##">缓慢</a>处境互相抵消。',
    '飞行': '角色不会成为近战攻击的有效目标。',
    '————': '——————————————————————————————————————————————————',
  };
