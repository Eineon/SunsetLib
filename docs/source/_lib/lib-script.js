document.addEventListener('DOMContentLoaded', function () {
  ...
  const tagData = {
    ...
    '扫荡': '这种效果能令立即将角色无力化，但难以对较为强大的角色产生效果。<br>角色的最大效果阶层每比扫荡效果的阶层高1阶，就会在应对扫荡效果的防御检定上获得2点加值。',
    ...
    '轻型': '如果角色使用轻型武器发动攻击，则因此产生的连击减值将获得1点减值。',
    '重型': '如果角色使用重型武器发动攻击，则因此产生的连击减值将受到1点加值。',
    '装填': '这种武器每刻只能使用1次。',
