document.addEventListener('DOMContentLoaded', function () {
  ...
  const tagData = {
    ...
    'R': '这种稀有度的事物需要特殊的训练或特定文化的背景才有可能接触。分析稀有度为R的事物时，DV会提高1点。',
    'S': '这种稀有度的事物几乎不可能被找到。分析稀有度为R的事物时，DV会提高2点。',
    'U': '这种稀有度的事物是独一无二的。分析稀有度为R的事物时，DV会提高4点。',
    '————': '——————————————————————————————————————————————————',
