document.addEventListener('DOMContentLoaded', function () {
  ...
  const tagData = {
    ...
    '————': '——————————————————————————————————————————————————',
    '密传': '密传术法的核心理论在于「支配」。如果角色的PAS未到达 <code>3+术法阶层/5</code> 点，则无法施行这种术法。<br>这种术法同时视为具有<a href="##">魔能</a>标签。',
    '契绊': '契绊术法的核心理论在于「引导」。<a href="##">无意识</a>的角色无法施行这种术法。<br>这种术法同时视为具有<a href="##">魔能</a>标签。',
    '炼成': '炼成术法的核心理论在于「转变」。这种派系不会对术法的施行构成限制。<br>这种术法同时视为具有<a href="##">魔能</a>标签。',
