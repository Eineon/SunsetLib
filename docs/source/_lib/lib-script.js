document.addEventListener('DOMContentLoaded', function () {
  ...
  const tagData = {
    ...
    '原型': '这项特技属于一种<b>原型</b>。',
    '入门': '一旦习得某种<b>原型</b>的<a href="##">入门</a>特技，直到习得至少5个属于该<b>原型</b>的特技 (含<a href="##">入门</a>特技) 为止，无法再习得其他的<a href="##">入门</a>特技。',
    '————': '——————————————————————————————————————————————————',
    ...
    '轻型': '如果角色在自己的回合仅使用轻型武器发动攻击，则其本回合的延迟将获得1点减值。',
    '重型': '如果角色在自己的回合使用重型武器发动攻击，则其本回合的延迟将受到1点加值。',
    '装填': '这种武器每轮只能使用1次。',
    '————': '——————————————————————————————————————————————————',
  };
